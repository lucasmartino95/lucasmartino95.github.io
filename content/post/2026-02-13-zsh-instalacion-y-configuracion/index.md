...
Con **Zsh** podemos tener un mejor autocompletado de comandos y además resaltado de
sintáxis.
...
que queremos ejecutar. También hay otros comandos útiles, en la 
[ArchWiki](https://wiki.archlinux.org/title/Fzf) están documentados. Para instalarlo y configurarlo es muy simple:
...
Dejo a continuación [mi .zshrc](https://github.com/lucasmartino95/dotfiles/blob/main/.zshrc) 
completo, el cual está debidamente comentado:
